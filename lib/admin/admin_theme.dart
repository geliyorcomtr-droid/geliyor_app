...
/// Admin paneli vurgu renkleri. Uygulama paletini bozmaz.
class AdminAccents {
  AdminAccents._();

  static const Color dashboard = AppColors.primary;
  static const Color orders = AppColors.warning;
  static const Color products = AppColors.success;
  static const Color foodTracking = Color(0xFF8B5CF6);
  static const Color members = Color(0xFF6366F1);
